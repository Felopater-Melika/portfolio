    ...
    >
      <div className=" space-y-2">
        ...
        <div className="sm:grid sm:columns-2 sm:grid-cols-2 lg:pt-8">
          <p className="text-center font-display text-white sm:pl-4 sm:text-left sm:text-xl  lg:text-2xl">
            ...
            React.js <FaReact className="inline" />, based in Tennessee, USA. I
            am a self-learner and self-motivated person; I was able to teach
            myself how to code while having high grades at school. I know how to
            use my skills to solve problems. I am a person who is always willing
            to learn new skills to do the work needed. I am currently looking
            for a job in the field of web development and currently learning
      ...
      <div className="space-y-3 pb-3 lg:pt-10">
        ...
        <p className="text-center font-display text-white sm:text-xl lg:text-2xl">
          I can build beautiful websites written in clean and efficient code. I
          can learn anything on my own and require little help. I also can and
          love working with teams on the job as I believe working as a team
          brings success.
        </p>
      </div>
